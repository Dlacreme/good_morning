defmodule GM.Account.Token do
  @moduledoc """
  Generates, Parse & validated all tokens used within the app
  """
  alias GM.Repo
  alias GM.Account.Users
  alias GM.Account.Tokens
  alias GM.Account.Const.TokenType
  ...
  defp sign_token(user_id, type), do: Phoenix.Token.sign(GMWeb.Endpoint, type, user_id)
end
